...
The cases have to be under `input\bin\bin`.
...
| Refusing to run UC1 ... does not identify as a case of the HSI Human Brain Database | The folder is not a recorded case. Point it at a case folder under `input\bin\bin` |
